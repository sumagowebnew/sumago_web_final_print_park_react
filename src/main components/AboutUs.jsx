                    ...
                    <div className="elementor-container elementor-column-gap-default">
                        <div className="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-84f6fd6"
                            ...
                            <div className="elementor-widget-wrap elementor-element-populated">
                                <div className="elementor-element elementor-element-6b4ef5a elementor-widget elementor-widget-printpark_float_image"
                                    ...
                                    <div className="elementor-widget-container">
                                        ...
                                        <section className="weare-section p-0 m-0">
                                            <div className="image-column">
                                                <div className="image-box">
                                                    ...
                                                    <figure className="image"><img decoding="async"
                                                        src={vision}
